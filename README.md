...
Beim ersten Besuch erkennt die Website automatisch einen ungefaehren Standort ueber die Internetverbindung und zeigt direkt lokales Wetter. Danach kann der Besucher mit **Genauen Standort verwenden** die genauere Browser-Standortabfrage erlauben.

Wenn die automatische Erkennung nicht funktioniert, zeigt die Website Berlin als sichere Standardstadt. Die genaue Browser-Standortabfrage funktioniert auf echten Websites nur mit HTTPS. Vercel stellt HTTPS automatisch bereit, deshalb funktioniert diese Funktion nach der Vercel-Veroeffentlichung richtig.
